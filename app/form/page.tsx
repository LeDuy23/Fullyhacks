...
export default function FormPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/claim-page.jpg')" }}
    >
      {/* About Us Button */}
              ...
              <CardContent className="space-y-4">
                {index === 0 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="name" placeholder="Lebron James" />
                    </div>
                    <div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input id="address" placeholder=" Lakers house, 92840" />
                    </div>
                  </div>
                )}
                ...
                <div>
                  ...
                  <Select
                    value={item.room}
                    onValueChange={(value) =>
                      handleFieldChange("room", value, index)
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      value={item.cost}
                      onChange={(e) =>
                        handleFieldChange("cost", e.target.value, index)
                      }
                    />
                  </div>
                  <div>
                    <Label htmlFor="receipt">Upload Photo/Receipt</Label>
                    <Input
                      id="receipt"
                      type="file"
