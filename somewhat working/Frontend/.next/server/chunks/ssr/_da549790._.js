...
"[project]/.next-internal/server/app/form/page/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
function FormPage() {
    ...
    const [room, setRoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleNext = ()=>{
        // Push data to Firebase when moving to the next page
        pushDataToFirebase();
        router.push("/summary");
    };
    const handleBack = ()=>{
    ...
    const pushDataToFirebase = ()=>{
        // Push the current items data to Firebase
        const itemsRef = ref(db, "items"); // Reference to the "items" node in Firebase
        items.forEach((item, index)=>{
            const newItemRef = ref(db, "items/" + index); // Push each item as a new child under "items"
            set(newItemRef, {
                room: item.room,
...
//# sourceMappingURL=_da549790._.js.map