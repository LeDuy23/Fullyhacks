...
"[project]/app/pdf/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PDFPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PDFPage.useEffect": ()=>{
            ...
            const fetchItems = {
                "PDFPage.useEffect.fetchItems": async ()=>{
                    try {
                        ...
                        if (data) {
                            const fetchedItems = await Promise.all(Object.keys(data).map({
                                "PDFPage.useEffect.fetchItems": async (key)=>{
                                    const item = {
                                        id: key,
                                        ...data[key]
                                    };
                                    if (item.file) {
                                        ...
                                        const fileRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(storage, `images/${item.file}`);
                                        const downloadURL = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDownloadURL"])(fileRef);
                                        item.file = downloadURL;
                                    }
                                    return item;
                                }
                            }["PDFPage.useEffect.fetchItems"]));
    ...
    }["PDFPage.useEffect"], []); // Runs once when the component is mounted
    const generatePDF = ()=>{
        if (!pdfRef.current) return;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(pdfRef.current, {
...
_s(PDFPage, "Rwb8U+kUw3Gw8FPYQSMDF6hBS2A=");
_c = PDFPage;
var _c;
...
//# sourceMappingURL=_e56267d6._.js.map