                ...
                "PDFPage.useEffect.fetchItems": async ()=>{
                    try {
                        ...
                        const validItems = Object.keys(data).map({
                            "PDFPage.useEffect.fetchItems.validItems": (key)=>({
                                    id: key,
                                    ...data[key]
                                })
                        }["PDFPage.useEffect.fetchItems.validItems"]).filter({
                            "PDFPage.useEffect.fetchItems.validItems": (item)=>item.room && item.description && item.cost
                        }["PDFPage.useEffect.fetchItems.validItems"]); // Filter out invalid items
                        setItems(validItems);
                    } catch (error) {
...
//# sourceMappingURL=_3b7723a9._.js.map