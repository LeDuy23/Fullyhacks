        ...
        <Card className="w-full max-w-md bg-blue-950 text-white rounded-2xl">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block mb-1 font-medium">Select Language ( feature in progess! )</label>
              ...
              <div>
                <label className="block mb-1 font-medium">Select Currency ( feature in progess! )</label>
