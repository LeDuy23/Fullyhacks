      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <h3 className="font-semibold text-xl mb-2">Jacob Fishel</h3>
            <h3> Back-End Lead </h3>  
            <p>   I am a Junior in computer science and I am interested in AI and machine learning, 
              specifically computer vision. On my free time i'm either gaming or hanging out with my friends. 
          ...
          <h3 className="font-semibold text-xl mb-2">Duy Le</h3>
            ...
            <p>    I am a Junior in computer science and I am interested in AI and fintech,
               specifically in quantitative finance. On my free time I like to golf and gamble. 
            </p>
          </div>
          <div className="bg-white/90 text-black p-6 rounded-xl shadow text-center">
          <h3 className="font-semibold text-xl mb-2">Philip Ma</h3>
            <h3> Back-End Lead </h3>  
            <p>   My name is Philip Ma. I'm a 3rd year computer science student with an interest in Fintech.
               I love reading and working out in my free time too. 
            </p>
          </div>
        </div>
      </div>
